...
class CountDown extends Component {
  ...
  componentDidMount() {
    this.deadline = new Date("FEB 04, 2022 20:00:00").getTime();
  ...
  render() {
    ...
    return (
      <div id="countdown">
          ...
          <span class="flip-clock-divider hours"><span className="flip-clock-label">Hours</span><span className="flip-clock-dot top"></span><span className="flip-clock-dot bottom"></span></span>
            <div className="box">
            <p id="hour">{hours}</p>
